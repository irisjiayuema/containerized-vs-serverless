...
# model.add(Embedding(2500, embedding_vector_length, input_shape=(max_review_length,)))
...
formatted = []
for i in test_x[0:100]:
    # Directly create the string and append it to `formatted` without wrapping it in a list
    formatted_string = ", ".join(map(str, i))
    # formatted_string2 = formatted_string.replace('\'', '')
    formatted.append([formatted_string])  # If you still want each string in its own list
print(formatted)
